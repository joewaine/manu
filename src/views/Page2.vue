...
<SecondHeroModule v-bind:link="'dsa'" v-bind:icon="'2'" v-bind:phase="2" v-bind:header="'Service alerts'" v-bind:subheader="'Get instant notifications and alerts about device health to automate the service request generation process using predefined rules'" />
...
<FooterModule  v-bind:link="'page3'" v-bind:linkText="'Technician dispatching'" />
								<!-- <UniversalFooter /> -->
				</div>
</template>
<script>
