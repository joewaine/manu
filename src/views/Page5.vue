<template>
	<div>
		<section class="section-pad-sm bg-light-grey">
			<div class="container no-lr-pad-mob">
				<SecondHeroModule
					...
					v-bind:icon="'5'"
					v-bind:phase="5"
					v-bind:header="'Global visibility'"
					v-bind:subheader="
						'Equip technicians with sales data so they can take advantage of cross-selling and upselling opportunities, making data-driven recommendations based on their customers usage and demonstrated needs.'
					"
				/>
				...
				<div class="row">
					...
					<ListRow
						v-bind:backgroundImage="'bg-gradient'"
						v-bind:Subheader1="'Process'"
						v-bind:BodyText1="
							'The predictive analytics manufacturing solution includes an in-house shop floor control tool that collects machining and tool data. It then sends the data to Microsoft Azure for real-time analysis using machine learning algorithms from Cortana Intelligence. Machining data is also collected from sensorized cutting tools through Azure IoT. With the help of Azure Machine Learning and Streaming Analytics, Sandvik Coromant added embedded intelligence to these tools to capture data that can be used to automatically adjust equipment, notify technicians when maintenance is needed, and alert plant managers of a potential failure.'
						"
						v-bind:Subheader2="'Results'"
						v-bind:BodyText2="
							'<ul><li><span>Reduced the time needed to make emergency shutdown decisions from two seconds to 100 milliseconds</span></li><li><span>Provided instant feedback to customers to improve efficiencies</span></li><li><span>Delivered cost savings of millions of dollars</span></li></ul>'
						"
						v-bind:Subheader3="'Related products:'"
						v-bind:BodyText3="
							'<ul><li><span>Microsoft Azure IoT Hub</span></li><li><span>Microsoft Azure IoT solution accelerators</span></li><li><span>Cortana Intelligence Suite</span></li><li><span>Microsoft Dynamics 365 for Field Service</span></li></ul>'
						"
					/>
					...
					<QuoteRow
						...
						v-bind:quoteTitle="
							'Chief Enterprise Architect and Senior Manager,'
						"
		...
		<FooterModule
			...
			v-bind:link="'/'"
			v-bind:linkText="'Return to home'"
		/>
	</div>
</template>
<script>
