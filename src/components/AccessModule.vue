<template>
	<div>
		<section id="access-module" class="access-module">
			<div class="container">
				<div class="row relative text-center">
							...
							<div style="display: none;">
								<div class="pent-tag tag-1">
									<router-link
										...
										to="/page1"
										@mouseover="hoverSibling(1)"
										@mouseleave="unHoverSibling(1)"
										v-on:click.native="
											closeModal();
											scrollTop();
										"
								...
								<div class="pent-tag tag-2">
									<router-link
										class="pent-tag-modal"
										to="/page2"
										@mouseover="hoverSibling(2)"
										@mouseleave="unHoverSibling(2)"
										v-on:click.native="
											closeModal();
											scrollTop();
										"
								...
								<div class="pent-tag tag-3">
									<router-link
										class="pent-tag-modal"
										to="/page3"
										@mouseover="hoverSibling(3)"
										@mouseleave="unHoverSibling(3)"
										v-on:click.native="
											closeModal();
											scrollTop();
										"
								...
								<div class="pent-tag tag-4">
									<router-link
										class="pent-tag-modal"
										to="/page4"
										@mouseover="hoverSibling(4)"
										@mouseleave="unHoverSibling(4)"
										v-on:click.native="
											closeModal();
											scrollTop();
										"
								...
								<div class="pent-tag tag-5">
									<router-link
										class="pent-tag-modal"
										to="/page5"
										@mouseover="hoverSibling(5)"
										@mouseleave="unHoverSibling(5)"
										v-on:click.native="
											closeModal();
											scrollTop();
										"
					...
					<div v-on:click="closeModal()" class="close-modal">
						<svg
							version="1.1"
							...
							style="enable-background:new 0 0 34.58 34.58;"
							xml:space="preserve"
						>
							<g>
								<g>
									<polygon
										class="st7 close"
										points="34.58,1.93 32.65,0 17.29,15.36 1.93,0 0,1.93 15.36,17.29 0,32.65 1.93,34.58 17.29,19.22
			32.65,34.58 34.58,32.65 19.22,17.29"
									/>
								</g>
							</g>
						</svg>
